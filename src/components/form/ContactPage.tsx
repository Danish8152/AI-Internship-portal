...
export default function ContactPage() {
  ...
  return (
    <div className="relative overflow-hidden min-h-screen bg-[#0d0d0d] text-zinc-300 py-16 px-4 selection:bg-orange-500 selection:text-black">
      <NotificationToast
        ...
        message={
          <>
            Thank you for reaching out. Our partnerships team will contact you
            within 48 hours at{" "}
      ...
      <NotificationToast
        visible={
          submitStatus === "error"
          && (Object.keys(errors).length > 0 || Boolean(submitErrorMessage))
        }
        type="error"
        ...
        <SectionCard title="Send Us a Message / संदेश भेजें">
          <form onSubmit={handleSubmit} noValidate className="space-y-2">
            ...
            <FormTextarea
              ...
              placeholder="Tell us how you would like to collaborate with BSERC..."
              rows={6}
              required
